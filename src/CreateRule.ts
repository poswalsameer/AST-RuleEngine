...
// function createRule(ruleString: string): ASTNode {
...
//   function parseCondition(condition: string): ASTNode {
//     const operators = [">", "<", "=", ">=", "<="];
...
//   function combineRules(rules: string[], operator: string = "AND"): ASTNode {
...
//   function evaluateRule(ast: ASTNode, data: { [key: string]: any }): boolean {
